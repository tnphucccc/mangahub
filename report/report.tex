...
\begin{titlepage}
    ...
    \vspace{0.5cm}
    {\large Network Programming Project Report} \\
    \vspace{1.5cm}
    ...
    {\large \textbf{IT096IU - Network Programming}} \\
    \vspace{0.5cm}
    {\large Instructor: Dr. Lê Thanh Sơn} \\
    \vfill
    A project report submitted in partial fulfillment of the requirements for \\
    the Network Programming course (IT096IU) \\
    \vspace{0.8cm}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|p{10cm}|}
        ...
        Tran Nguyen Phuc & Backend development (HTTP API, TCP Server, UDP Server), Database design and implementation, Testing and quality assurance, Deployment and DevOps, Report writing (Chapters 3-5) \\ \hline
        Nguyen Mach Khang Huy & Frontend development (Next.js, WebSocket integration), gRPC service implementation, System architecture documentation, Report writing (Chapters 1-2, 6) \\ \hline
    \end{tabular}
